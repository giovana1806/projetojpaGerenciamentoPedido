...
@Tag(name = "Pedidos", description = "API REST DE GERENCIAMETO DE CLIENTES")  
@RestController   
...
public class PedidoController {   
	...
	public ResponseEntity<Pedido> alteraPedidosControl(@PathVariable Long id, @RequestBody @Valid Pedido pedido){   
